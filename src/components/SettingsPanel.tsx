...
const SettingsPanel = memo(function SettingsPanel({
  ...
  return (
    <div className="w-80 bg-white dark:bg-gray-50 border-l border-gray-200 dark:border-gray-200 h-screen overflow-y-auto">
      <div className="p-6 space-y-6">
        {/* Header */}
        <div>
          <h2 className="text-xl font-bold text-gray-800 dark:text-gray-700 mb-2">
            Settings
          </h2>
        ...
        {/* Persona Selector */}
        <div>
          <label className="block text-sm font-semibold text-gray-700 dark:text-gray-600 mb-2">
            Persona
          </label>
          <select
            ...
            className="w-full px-3 py-2 bg-gray-100 dark:bg-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-600 text-gray-800 dark:text-gray-700"
          >
        ...
        {/* Memory Card (Mock) */}
        <div className="border border-gray-200 dark:border-gray-300 rounded-lg p-4 bg-gray-50 dark:bg-white/50">
          <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-600 mb-2">
            📝 Memory Card
          </h3>
