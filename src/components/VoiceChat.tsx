...
export function VoiceChat({
      ...
      try {
        ...
        setMessages(
          msgs.map((m) => ({
            ...
            role: m.role,
            content: m.content,
            learningNote: m.learningTip || undefined,
  ...
  return (
    <div className="relative flex flex-col h-screen bg-gray-50 text-gray-900 overflow-hidden">
      {/* Minimal Top Bar */}
                  ...
                  {msg.role === "assistant" && msg.learningNote && (
                    <div className="mt-3 pt-3 border-t border-gray-300">
                      <button
                        ...
                        className="flex items-center justify-between w-full text-left text-sm text-amber-700 hover:text-amber-800 transition"
                      >
                      ...
                      {expandedNotes.has(msg.id) && (
                        <div className="mt-2 p-3 bg-amber-50 border border-amber-200 rounded-lg">
                          <p className="text-xs text-amber-900 whitespace-pre-wrap">{msg.learningNote}</p>
                        </div>
                      )}
                    </div>
                  )}
