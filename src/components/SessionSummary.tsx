    ...
    return (
      <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
        <div className="bg-white rounded-xl p-8">
          ...
          <p className="text-gray-900 mt-4">분석 중...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="space-y-4 mb-6">
          <div className="bg-gray-100 rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-gray-500">⏱️ 대화 시간</span>
          ...
          <div className="bg-gray-100 rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              <span className="text-gray-500">💬 대화 점유율</span>
          ...
          <div className="bg-gray-100 rounded-lg p-4">
            <div className="flex items-center justify-between">
              <span className="text-gray-500">📈 말하기 레벨</span>
        ...
        {isPro ? (
          <div className="bg-purple-900 bg-opacity-50 rounded-lg p-4 mb-6">
            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                <span className="text-gray-600">평균 문장 길이</span>
          ...
          <div className="bg-blue-900 bg-opacity-30 rounded-lg p-4 mb-6 text-center">
            ...
            <button className="bg-primary-500 hover:bg-primary-600 px-4 py-2 rounded-lg text-sm font-bold">
              Pro 알아보기
            </button>
          </div>
        )}
          ...
          {summary.isComplete ? (
            <>
              ...
              <button
                ...
                className="w-full bg-gray-100 hover:bg-gray-600 px-6 py-3 rounded-lg"
              >
                🔄 새 대화 시작
              </button>
            </>
            ...
            <>
              <button
                onClick={onClose}
                className="w-full bg-primary-500 hover:bg-primary-600 px-6 py-3 rounded-lg font-bold"
              >
                ▶️ 대화 계속하기
              </button>
              <button
